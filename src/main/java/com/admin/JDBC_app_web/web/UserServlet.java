...
import com.admin.JDBC_app_web.dao.DBconnector;
import com.admin.JDBC_app_web.dao.DBoperator;
...
public class UserServlet extends HttpServlet {
    ...
    private DBoperator dBoperator = new DBoperator(DBconnector.getInstance());
